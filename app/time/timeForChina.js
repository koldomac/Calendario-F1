Lungo.dom('#liChina').tap(function(event) {
    ...
    var url = "http://json-dsttime.appspot.com/?to_tz=" + timezone.name() + "&from_tz=Asia/Shanghai&dt=2013-04-14T15:00";

    Lungo.Service.cache(url, {}, "6 hours", function(response) {
        if (response == "") {

            var afterNotification = function() {
                Lungo.dom('#raceChina').text('15:00');
            };
            if (Lungo.Data.Storage.persistent("idioma") == "EN") {
            ...
            Lungo.dom('#raceChina').html(html.substring(11,16));
