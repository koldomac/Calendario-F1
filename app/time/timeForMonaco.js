Lungo.dom('#liMonaco').tap(function(event) {
    ...
    var url = "http://json-dsttime.appspot.com/?to_tz=" + timezone.name() + "&from_tz=Europe/Berlin&dt=2013-05-26T14:00";

    Lungo.Service.cache(url, {}, "6 hours", function(response) {
        if (response == "") {

            var afterNotification = function() {
                Lungo.dom('#raceMonaco').text('14:00');
            };
            if (Lungo.Data.Storage.persistent("idioma") == "EN") {
            ...
            Lungo.dom('#raceMonaco').html(html.substring(11,16));
