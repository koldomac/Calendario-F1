Lungo.dom('#liSpain').tap(function(event) {
    ...
    var url = "http://json-dsttime.appspot.com/?to_tz=" + timezone.name() + "&from_tz=Europe/Berlin&dt=2013-05-12T14:00";

    Lungo.Service.cache(url, {}, "6 hours", function(response) {
        if (response == "") {

            var afterNotification = function() {
                Lungo.dom('#raceSpain').text('14:00');
            };
            if (Lungo.Data.Storage.persistent("idioma") == "EN") {
            ...
            Lungo.dom('#raceSpain').html(html.substring(11,16));
