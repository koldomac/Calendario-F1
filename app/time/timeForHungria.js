Lungo.dom('#liHungria').tap(function(event) {
    ...
    var url = "http://json-dsttime.appspot.com/?to_tz=" + timezone.name() + "&from_tz=Europe/Budapest&dt=2013-07-28T14:00";

    Lungo.Service.cache(url, {}, "6 hours", function(response) {
        if (response == "") {

            var afterNotification = function() {
                Lungo.dom('#raceHungria').text('14:00');
            };
            if (Lungo.Data.Storage.persistent("idioma") == "EN") {
            ...
            Lungo.dom('#raceHungria').html(html.substring(11,16));
