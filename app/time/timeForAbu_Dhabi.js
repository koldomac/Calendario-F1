Lungo.dom('#liAbu_Dhabi').tap(function(event) {
    ...
    var url = "http://json-dsttime.appspot.com/?to_tz=" + timezone.name() + "&from_tz=Asia/Baku&dt=2013-11-03T17:00";

    Lungo.Service.cache(url, {}, "6 hours", function(response) {
        if (response == "") {

            var afterNotification = function() {
                Lungo.dom('#raceAbu_Dhabi').text('17:00');
            };
            if (Lungo.Data.Storage.persistent("idioma") == "EN") {
            ...
            Lungo.dom('#raceAbu_Dhabi').html(html.substring(11,16));
